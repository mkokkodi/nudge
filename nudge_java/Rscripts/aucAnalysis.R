auc500k <- read.table(file="/Users/mkokkodi/git/nudge/data/results/20_soft_dev/L1R_LR_aucPoints_C1_I0_Hourly.csv",head=TRUE,sep=",")
auc1m <- read.table(file="/Users/mkokkodi/git/nudge/data/results/20_soft_dev/L1R_LR_aucPoints_C1_I0_Fixed.csv",head=TRUE,sep=",")
...
legend( "topleft", c("Hourly Jobs","Fixed Jobs"), cex=1, 
        col=c("blue","red","black"), pch=c(12,22,-1), lty=1:5)
